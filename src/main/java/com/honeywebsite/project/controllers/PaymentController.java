        ...
        if (customerEmail == null) {
            ...
            if (customerEmail != null) {
                try {
                    ...
                    StringBuilder emailContent = new StringBuilder("Hvala Vam na vašoj kupnji kod Pčelarstvo Pavlović! Ovime potvrđujemo primitak Vaše narudžbe.\n\nDetalji narudžbe:\n");
                    ...
                    emailContent.append("\nUkupno plaćeno: ").append(String.format("%.2f", session.getAmountTotal() / 100.0)).append(" ").append(session.getCurrency().toUpperCase());
                    emailContent.append("\nAko imate bilo kakvih pitanja ili trebate dodatne informacije, slobodno nas kontaktirajte na ").append(emailVlasnika).append(" ili putem telefona na broj +385 99 799 4174.");
